...
begin
  ...
  try
    ...
    begin
      ...
      begin
        ShowMessage('O usuário não possui permissões para o Perfil Financeiro');
        Result := False;
      end
      else
      begin
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        ShowMessage('O usuário não possui permissões para o Perfil Biblioteca');
        Result := False;
      end
      else
      begin
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        ShowMessage('O usuário não possui permissões para o Perfil Contas a Pagar');
        Result := False;
      end
      else
      begin
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        ShowMessage('O usuário não possui permissões para o Perfil Controladoria');
        Result := False;
      end
      else
      begin
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        ShowMessage('O usuário não possui permissões para o Perfil Tesouraria');
        Result := False;
      end
      else
      begin
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        ShowMessage('O usuário não possui permissões para o Perfil Vestibular');
        Result := False;
      end
      else
      begin
